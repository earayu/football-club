...
export default function LoginPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-black tracking-tight text-zinc-900">{t("loginTitle")}</h1>
        <p className="mt-1.5 text-sm text-zinc-500">Good to have you back.</p>
      </div>
      ...
      <form action={handleSubmit} className="space-y-4">
        ...
        <Input id="password" name="password" type="password" label={t("password")} placeholder="••••••••" required minLength={6} autoComplete="current-password" />
